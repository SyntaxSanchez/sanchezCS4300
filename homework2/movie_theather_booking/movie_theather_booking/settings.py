"""
Django settings for movie_theather_booking project.
...
SECRET_KEY = 'django-insecure-c2^5fvh9sq5f^5c$tx4n%8d7$oj2_q+^h82$sj&z75)khc)&ld'
...
WSGI_APPLICATION = 'movie_theather_booking.wsgi.application'
